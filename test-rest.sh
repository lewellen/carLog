...
curl -X POST "http://127.0.0.1:5000/mileage" -H "Content-Type:application/json" -d '{ "vehicleId" : 1, "providerId" : 1, "destinationId" : 1, "fromDate" : "2017-05-01 00:00:00", "toDate" : "2017-05-19 00:00:00", "tripMileage" : 100.5, "totalMileage" : 80000, "gallons" : 10.5, "pricePerGallon" : 2.32 }'
...
curl -X POST "http://127.0.0.1:5000/events" -H "Content-Type:application/json" -d '{"at":"2017-05-28","totalMileage":"12312","description":"asdfasdf","vehicleId":"1","id":"-1"}'
...
# Updates
curl -X POST "http://127.0.0.1:5000/users" -H "Content-Type:application/json" -d '{"id" : 2, "name" : "John A. Smith"}'
curl -X POST "http://127.0.0.1:5000/vehicles" -H "Content-Type:application/json" -d '{"id" : 1, "userId" : 1, "vin" : "TBD", "make" : "Make", "model" : "model", "year" : "2017", "stillOwn" : "0" }'
curl -X POST "http://127.0.0.1:5000/mileage" -H "Content-Type:application/json" -d '{"id" : 1, "vehicleId" : 1, "providerId" : 1, "destinationId" : 1, "fromDate" : "2017-05-01 00:00:00", "toDate" : "2017-05-19 00:00:00", "tripMileage" : 200.5, "totalMileage" : 80000, "gallons" : 10.5, "pricePerGallon" : 2.32 }'
...
curl -X POST "http://127.0.0.1:5000/events" -H "Content-Type:application/json" -d '{"id" : 1, "at":"2017-05-28","totalMileage":"12312","description":"asdfasdf21","vehicleId":"1"}'
